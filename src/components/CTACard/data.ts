import { CreateDAO } from "src/utils/paths";

import learnImg from "src/assets/learnDao.svg";
import buildFaster from "src/assets/buildFaster.svg";
import createDaoImg from "src/assets/createDao.svg";
